...
def train(args):
    ...
    while pre_epoch < args.pre_train_epoch:
        ...
        if pre_epoch % 50 ==0:
            torch.save(generator.state_dict(), 'C:/Users/USER/SRGAN/model/pre_trained_model_%03d.pt'%pre_epoch)
    ...
    while fine_epoch < args.fine_train_epoch:
        ...
        if fine_epoch % 50 ==0:
            ...
            torch.save(generator.state_dict(), 'C:/Users/USER/SRGAN/model/SRGAN_gene_%03d.pt'%fine_epoch)
            torch.save(discriminator.state_dict(), 'C:/Users/USER/SRGAN/model/SRGAN_discrim_%03d.pt'%fine_epoch)
...
def test(args):
    ...
    with torch.no_grad():
        for i, te_data in enumerate(loader):
            ...
            result.save('C:/Users/jihun/SRGAN-PyTorch/result/res_%04d.png'%i)
...
def test_only(args):
    ...
    with torch.no_grad():
        for i, te_data in enumerate(loader):
            ...
            output = output.transpose(1,2,0)
            result = Image.fromarray((output * 255.0).astype(np.uint8))
            result.save(r'C:\Users\USER\SRGAN\result\myresult\res_%04d.png'%i)
